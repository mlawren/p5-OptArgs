...
#line 1 "OptArgs2::Arg_CI"
use strict;use warnings;package OptArgs2::Arg_CI;our$INLINE;
sub import {$INLINE=exists $_[1]->{'has'}? $_[1]: {has=>$_[1]}}package
OptArgs2::Arg;BEGIN{$INC{'OptArgs2/Arg.pm'}=__FILE__}require Carp;
...
s/^.*?\n(.*)\n.*?\n/$1/s;Carp::carp($self ."\n".$x ."\n ")}
sub __CHECK {if (my@missing=grep {not exists $_[0]->{$_}}'comment','isa',
'name'){Carp::croak('OptArgs2::Arg attribute(s) required: ' .join(', ',
@missing))}}
sub cmd {if (@_ > 1){$_[0]{'cmd'}=$_[1];return $_[0]}$_[0]{'cmd'}}
sub comment {$_[0]->__RO($_[1])if @_ > 1;$_[0]{'comment'}}
sub default {$_[0]->__RO($_[1])if @_ > 1;$_[0]{'default'}}
sub fallback {if (@_ > 1){$_[0]{'fallback'}=$_[1];return $_[0]}$_[0]{
'fallback'}}
sub getopt {if (@_ > 1){$_[0]{'getopt'}=$_[1];return $_[0]}$_[0]{'getopt'}}
sub greedy {$_[0]->__RO($_[1])if @_ > 1;$_[0]{'greedy'}}
sub isa {$_[0]->__RO($_[1])if @_ > 1;$_[0]{'isa'}}
sub isa_name {if (@_ > 1){$_[0]{'isa_name'}=$_[1];return $_[0]}$_[0]{
'isa_name'}}
sub name {$_[0]->__RO($_[1])if @_ > 1;$_[0]{'name'}}
sub required {$_[0]->__RO($_[1])if @_ > 1;$_[0]{'required'}}
sub show_default {$_[0]->__RO($_[1])if @_ > 1;$_[0]{'show_default'}}
