...
#line 1 "OptArgs2::Opt_CI"
use strict;use warnings;package OptArgs2::Opt_CI;our$INLINE;
sub import {$INLINE=exists $_[1]->{'has'}? $_[1]: {has=>$_[1]}}package
OptArgs2::Opt;BEGIN{$INC{'OptArgs2/Opt.pm'}=__FILE__}require Carp;
...
'name'){Carp::croak('OptArgs2::Opt attribute(s) required: ' .join(', ',
@missing))}}
sub alias {$_[0]->__RO($_[1])if @_ > 1;$_[0]{'alias'}}
sub comment {$_[0]->__RO($_[1])if @_ > 1;$_[0]{'comment'}}
sub default {$_[0]->__RO($_[1])if @_ > 1;$_[0]{'default'}}
sub getopt {$_[0]->__RO($_[1])if @_ > 1;$_[0]{'getopt'}}
...
sub trigger {$_[0]->__RO($_[1])if @_ > 1;$_[0]{'trigger'}}
